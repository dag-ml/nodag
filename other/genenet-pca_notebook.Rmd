...
This notebook aims to explore the potential applications of [GeneNet PCA](https://CRAN.R-project.org/package=GeneNet).
...
ko <- ko[, c("expose", "mass", "trab", "stren", "resorp", "form")]
...
```{r}
# Subset data to only expose, mass, mass_meta, and trab_meta
glds_meta <- glds[, c("expose", "mass", "mass_meta", "trab_meta")]

# Subset data to only expose, mass, mass_epiph, and trab_epiph
glds_epiph <- glds[, c("expose", "mass", "mass_epiph", "trab_epiph")]
```
