...
# Plot DAGs
png('../dags/alwood_dag.png', width=12, height=12, units="cm", res=300)
plot(alwood_dag)
title("Alwood DAG (NoDag)")

png('../dags/ko_dag.png', width=12, height=12, units="cm", res=300)
plot(ko_dag)
title("Ko DAG (NoDag)")

png('../dags/turner_glds_dag.png', width=12, height=12, units="cm", res=300)
plot(glds_dag)
title("Turner GLDS-351 DAG (NoDag)")

png('../dags/turner_lsds_dag.png', width=12, height=12, units="cm", res=300)
plot(turner_dag)
title("Turner LSDS-30 DAG (NoDag)")
```
